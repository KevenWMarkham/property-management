...
export default function EditBookingPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const [bookingRes, propsRes, guestsRes] = await Promise.all([
        ...
        if (bookingRes.ok) {
          ...
          setFormData({
            ...
            nightlyRate: (booking.nightlyRate / 100).toString(),
            cleaningFee: booking.cleaningFee ? (booking.cleaningFee / 100).toString() : '',
    ...
    try {
      ...
      const res = await fetch(`/api/admin/bookings/${params.id}`, {
        ...
        body: JSON.stringify({
          ...
          nightlyRate: Math.round(parseFloat(formData.nightlyRate) * 100),
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="md:grid md:grid-cols-3 md:gap-6">
        <div className="md:col-span-1">
          <h2 className="text-lg font-medium text-gray-900">Edit Booking</h2>
