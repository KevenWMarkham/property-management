      ...
      try {
        ...
        if (res.ok) {
          ...
          setFormData({
            ...
            email: tenant.email,
            phone: tenant.phone,
            emergencyContactName: tenant.emergencyContact || '',
            emergencyContactPhone: tenant.emergencyPhone || '',
          });
        } else {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(`Failed to update tenant: ${errorData.error}`);
      }
    } catch (error) {
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="md:grid md:grid-cols-3 md:gap-6">
        <div className="md:col-span-1">
          <h2 className="text-lg font-medium text-gray-900">Edit Tenant</h2>
